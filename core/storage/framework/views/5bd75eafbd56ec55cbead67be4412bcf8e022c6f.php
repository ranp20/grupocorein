								...
								<form class="admin-form" action="<?php echo e(route('back.catalog.update',$catalog->id)); ?>" method="POST" enctype="multipart/form-data">
									...
									<div class="d-flex align-items-center justify-content-end">
										<label class="switch-primary">
											<input type="checkbox" class="switch switch-bootstrap radio-check__vCatalog" name="status" value="<?php echo e($catalog->status); ?>" <?php echo e(($catalog->status != "" && $catalog->status != 0) ? "checked" : ""); ?>>
