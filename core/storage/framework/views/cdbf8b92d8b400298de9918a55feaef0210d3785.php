...
<?php $__env->startSection('title'); ?>
  <?php echo e(__('Promotional Products')); ?>
    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="breadcrumbs">
          ...
          <li><a href="<?php echo e(route('front.onsaleproducts')); ?>"><?php echo e(__('Promotional Products')); ?></a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title">
          <h2 class="h3"><?php echo e(__('Promotional Products')); ?></h2>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row g-3">
      <div class="col-lg-12 order-lg-2" id="list_view_ajax">
        <?php echo $__env->make('front.onsaleproducts.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      
    </div>
  </div>
</div>
<form id="search_form_onsaleproducts" class="d-none" action="<?php echo e(route('front.getFilterOnSaleProducts')); ?>" method="GET">
  ...
  <button type="submit" id="search_button_onsaleproducts" class="d-none"></button>
</form>
<script type="text/javascript" src="<?php echo e(asset('assets/front/js/onsaleproducts.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\grupocorein\core\resources\views/front/onsaleproducts/index.blade.php ENDPATH**/ ?>