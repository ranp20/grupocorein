					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
						    <?php
						        ...
						        */
						    ?>
							<form class="admin-form" action="<?php echo e(route('back.category.update',$category->id)); ?>"	method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\grupocorein\core\resources\views/back/category/edit.blade.php ENDPATH**/ ?>