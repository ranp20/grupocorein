    ...
    <div class="col-gd">
      <div class="product-card">
        <div class="product-thumb cCatalogItm__cImgItm">
          <a href="<?php echo e(asset('assets/images/catalogs/'.$item->photo)); ?>" class="d-flex align-items-center justify-content-center" target="_blank">
            <img src="<?php echo e(asset('assets/images/catalogs/'.$item->photo)); ?>" alt="<?php echo e($item->name); ?>">
          </a>
        </div>
        ...
        <div class="cCatalogItm__cBtnDownload__dcWb">
          <a href="<?php echo e(asset('assets/files/catalogs/'.$item->adj_doc)); ?>" download="<?php echo e($item->adj_doc); ?>" class="cCatalogItm__cBtnDownload__dcWb__link">
