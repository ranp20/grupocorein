      ...
      <div class="user-avatar">
        <div class="c_useravatar">
          <div class="c_useravatar__img">
            <img id="avater_photo_view" src="<?php echo e($user->photo ? asset('assets/images/users/'.$user->photo) : asset('assets/images/placeholder.png')); ?>" alt="User">
          </div>
          <div class="c_useravatar__iptfile">
            ...
            <div class="c_useravatar__iptfile__uploadphoto" data-bghover="c-inputphoto">
              ...
              <input type="file" id="photo_avataruser-front" name="photo" accept="img/*" class="c_useravatar--iptfilePhoto imagen_front" data-href="<?php echo e(route('user.account.changeiconuser')); ?>" required="">
            </div>
          </div>
        </div>
      </div>
      <div class="user-data">
        <h4 class="h5"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h4><span><?php echo e(__('Joined')); ?> <?php echo e(cambiaf_mysql($user->created_at)); ?></span>
      </div>
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><?php echo e(__('Your account will be deleted along with all your data.')); ?> <?php echo e(__('Are You Sure?')); ?></p>
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\grupocorein\core\resources\views/includes/user_sitebar.blade.php ENDPATH**/ ?>