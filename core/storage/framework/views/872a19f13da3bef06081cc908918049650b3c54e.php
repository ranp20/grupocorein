  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="d-sm-flex align-items-center justify-content-between">
        ...
        <div class="right">
          <a class="btn btn-primary btn-sm d-inline-block" href="<?php echo e(route('back.item.add')); ?>">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" >
              <div class="form-group px-0">
                <select class="form-control" name="coupon_id">
                  <option disabled><?php echo e(__('Select coupon')); ?></option>
                  <option value=""><?php echo e(__('All Coupons')); ?></option>
                  ...
                  <option value="<?php echo e($coupon->id); ?>" <?php echo e(request()->input('coupon_id') == $coupon->id ? 'selected' : ''); ?>><?php echo e($coupon->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
            </div>
      ...
      <br>
			<div class="gd-responsive-table">
              ...
              <th><?php echo e(__('Sección')); ?></th>
							...
							<!-- NUEVO CONTENIDO (INICIO) -->
							<th class="d-tr_none"><?php echo e(__('SAP Code')); ?></th>
							<!-- NUEVO CONTENIDO (FIN) -->
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\grupocorein\core\resources\views/back/item/index.blade.php ENDPATH**/ ?>