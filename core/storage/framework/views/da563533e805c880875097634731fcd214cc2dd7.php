            ...
            <div class="gd-responsive-table">
              <table class="table table-bordered table-striped">
                <tr>
                  ...
                  <td> <input type="text" name="first_name" class="form-control" id="text" value="<?php echo e($user->first_name); ?>" ></td>
                </tr>
                <tr>
                  <th><?php echo e(__("SurNames")); ?></th>
                  <td><input type="text" name="last_name" class="form-control" id="text" value="<?php echo e($user->last_name); ?>" ></td>
                </tr>
                <tr>
                  <th><?php echo e(__("Email Address")); ?></th>
                  <td><input type="text" name="email" class="form-control" id="text" value="<?php echo e($user->email); ?>" ></td>
                </tr>
                <tr>
                  <th><?php echo e(__("Phone Number")); ?></th>
                  <td><input type="text" name="phone" class="form-control" id="text" value="<?php echo e($user->phone); ?>" ></td>
                </tr>
                <input type="hidden" name="user_id" id="" value="<?php echo e($user->id); ?>">
                <tr>
                  <th><?php echo e(__("Password")); ?></th>
                  <td><input type="password" name="password" class="form-control" id="text" placeholder="<?php echo e(__('Password')); ?>" value="" ></td>
                </tr>
                <tr>
