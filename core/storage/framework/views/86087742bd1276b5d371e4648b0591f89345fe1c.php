    ...
    <div class="product-card">
      ...
      <div class="product-thumb" >
        <a href="<?php echo e(route('front.product',$item->slug)); ?>" class="d-flex align-items-center justify-content-center">
          <img class="lazy" src="<?php echo e(asset('assets/images/items/'.$item->thumbnail)); ?>" data-src="<?php echo e(asset('assets/images/items/'.$item->thumbnail)); ?>" alt="Product">
        </a>  
      ...
      <div class="product-card-body">
        ...
        <p class="product-sku__2">SKU: <?php echo e(strlen(strip_tags($item->sku)) > 35 ? substr(strip_tags($item->sku), 0, 35) : strip_tags($item->sku)); ?></p>
