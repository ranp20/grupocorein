    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="breadcrumbs">
          ...
          <li><a href="{{route('front.onsaleproducts')}}">{{__('Promotional Products')}}</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title">
          <h2 class="h3">{{__('Promotional Products')}}</h2>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row g-3">
      <div class="col-lg-12 order-lg-2" id="list_view_ajax">
        @include('front.onsaleproducts.filter')
      </div>
      {{--
      <!--
...
<form id="search_form_onsaleproducts" class="d-none" action="{{route('front.getFilterOnSaleProducts')}}" method="GET">
...
<script type="text/javascript" src="{{asset('assets/front/js/onsaleproducts.js')}}"></script>
@endsection