            ...
            <div class="row g-3">
                ...
                <div class="product-card">
                    <div class="product-thumb">
                       ...
                       <a href="{{route('front.product',$compaign_item->item->slug)}}"> <img src="{{asset('assets/images/'.$compaign_item->item->photo)}}" alt="Product"></a>
                ...
                <p><a href="https://api.whatsapp.com/send?phone=51{{$setting->footer_phone}}&text=Solicito información sobre: {{route('front.product',$compaign_item->item->slug)}}" target="_blank" ><img src="{{route('front.index')}}/assets/images/boton-pedir-por-whatsapp.png" class="boton-as"></a></p>
