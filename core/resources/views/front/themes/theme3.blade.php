                                    ...
                                    <div class="slider-item">
                                        <div class="product-card ">
                                            <div class="product-thumb" >
                                                ...
                                                @endif
                                                <img class="lazy" data-src="{{asset('assets/images/'.$item->photo)}}" alt="Product">
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        ...
                                        @endif
                                            <img class="lazy" data-src="{{asset('assets/images/'.$popular_category_item->photo)}}" alt="Product">
                                ...
                                <div class="slider-item">
                                    ...
                                    <div class="product-card p-col">
                                        <a class="product-thumb" href="{{route('front.product',$two_column_category_item->slug)}}">
                                            ...
                                            <img class="lazy" data-src="{{asset('assets/images/'.$two_column_category_item->photo)}}" alt="Product"></a>
                                        <div class="product-card-body">
