				...
				<div class="card-body ">
                    ...
                    <br>
								...
								<div class="form-group">
									...
									<textarea name="meta_descriptions" id="meta_descriptions" class="form-control" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{$category->meta_descriptions}}</textarea>
								</div>
								<div class="form-group">
