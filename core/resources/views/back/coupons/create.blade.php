...
<div class="container-fluid">
	...
	<form class="admin-form" action="{{ route('back.coupons.store') }}" method="POST" enctype="multipart/form-data">
		@csrf
		...
		<div class="row">
			<div class="col-lg-7">
							...
							<div class="col-lg-12">
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="number" step="0.01" min="0" max="100" name="discount_percentage" id="discount_percentage" class="form-control" value="{{ isset($coupon) ? $coupon->discount_percentage : old('discount_percentage') }}" required>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="card">
					<div class="card-body">
						<div class="form-group">
							<label for="name">{{ __('Set Image') }} *</label><br>
							<img class="admin-img" src="{{  asset('assets/images/placeholder.png') }}" alt="No Image Found"><br>
					...
					<div class="card-body">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input class="form-control" type="date" name="date_init" value="{{ old('date_init') }}" id="date_init">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input class="form-control" type="time" name="time_end" min="<?php echo date('h:i'); ?>" value="{{ old('time_end') }}" id="time_end">
							</div>
						</div>
					</div>
				</div>
