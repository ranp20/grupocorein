                  ...
                  @csrf
                	@method('PUT')
									...
									<div class="form-group">
										...
										<input type="text" name="title" class="form-control page-name" id="title" placeholder="{{ __('Enter Title') }}" value="{{ $page->title }}" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea name="details" id="details" class="form-control text-editor" rows="5" placeholder="{{ __('Enter Details') }}" required>{{ $page->details }}</textarea>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea name="meta_descriptions" id="meta_descriptions" class="form-control" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{$page->meta_descriptions}}</textarea>
									</div>
...
<script type="text/javascript" src="{{asset('assets/back/js/page.js')}}"></script>
@endsection