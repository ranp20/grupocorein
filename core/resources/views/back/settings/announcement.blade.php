                        ...
                        <div class="image-show {{ $setting->is_announcement == 1 ? '' : 'd-none' }}">
                          <div class="form-group">
                            ...
                            <div class="col-lg-12 pb-1">
                              <img class="admin-img lg" src="{{ $setting->announcement ? asset('assets/images/announcements/'.$setting->announcement) : asset('assets/images/placeholder.png') }}" alt="No Image Found">
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="announcement_delay" class="form-control" id="announcement_delay" placeholder="{{ __('Announcement Delay') }}" value="{{ $setting->announcement_delay }}" >
                          </div>
                          <div class="form-group">
                            <label for="announcement_title">{{ __('Newsletter Title') }} *</label>
                            <input type="text" name="announcement_title" class="form-control" id="announcement_title" placeholder="{{ __('Popup Title') }}" value="{{ $setting->announcement_title }}" >
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="announcement_link" class="form-control" id="announcement_link" placeholder="{{ __('Link') }}" value="{{ $setting->announcement_link }}" >
                          </div>
                        </div>
                        <div>
