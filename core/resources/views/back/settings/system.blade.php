                                    ...
                                    <div id="wtspnumbers_number-section" class="cCt_wtpsNmbrs">
                                      ...
                                      <div class="cCt_wtpsNmbrs__c" id="wpsnumbsgadd_1Gdhj5-1lks">
                                        ...
                                        <div class="d-flex cCt_wtpsNmbrs__c__m">
                                          <div class="flex-grow-1 cCt_wtpsNmbrs__c__m__i">
                                            <div class="form-group">
                                              <input type="text" class="form-control" name="wtspnumbersgeneral_title[]" placeholder="" value="{{ $v['title'] }}" required>
                                            </div>
                                            <div class="form-group">
                                              <input type="text" class="form-control" name="wtspnumbersgeneral_text[]" placeholder="" value="{{ $v['text'] }}" required>
                                            </div>
                                            <div class="form-group">
                                              <input type="text" class="form-control" name="wtspnumbersgeneral_number[]" placeholder="" data-valformat="withspacesforthreenumbers" maxlength="9" value="{{ $v['number'] }}" required>
                                            </div>
                                          </div>
                                        </div>
                                        @endforeach
                                      ...
                                      <div class="cCt_wtpsNmbrs__c" id="wpsnumbsgadd_1Gdhj5-2lks">
                                        ...
                                        <div class="d-flex cCt_wtpsNmbrs__c__m">
                                          <div class="flex-grow-1 cCt_wtpsNmbrs__c__m__i">
                                            <div class="form-group">
                                              <input type="text" class="form-control" name="wtspnumbers_title[]" placeholder="" value="{{ $v['title'] }}" required>
                                            </div>
                                            <div class="form-group">
                                              <input type="text" class="form-control" name="wtspnumbers_text[]" placeholder="" value="{{ $v['text'] }}" required>
                                            </div>
                                            <div class="form-group">
                                              <input type="text" class="form-control" name="wtspnumbers_number[]" placeholder="" data-valformat="withspacesforthreenumbers" maxlength="9" value="{{ $v['number'] }}" required>
                                            </div>
                                          </div>
