      ...
      <div class="row">
        <div class="col-5 col-md-3">
          <div class="nav flex-column nav-pills nav-secondary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link active" id="v-pills-t1-tab" data-toggle="pill" href="#v-pills-t1" role="tab" aria-controls="v-pills-t1" aria-selected="false">{{ __('3 column banner First') }}</a>
          ...
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade" id="v-pills-t9" role="tabpanel" aria-labelledby="v-pills-t9-tab">
              <form class="admin-form" action="{{route('back.hero.banner.update')}}"method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="url1" class="form-control" id="url1" placeholder="{{ __('Enter Url') }}"  value="{{isset($hero_banner['url1']) ? $hero_banner['url1'] : ''}}" >
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="url2" class="form-control" id="url2" placeholder="{{ __('Enter Url') }}"  value="{{isset($hero_banner['url2']) ? $hero_banner['url2'] : ''}}" >
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane fade show active" id="v-pills-t1" role="tabpanel" aria-labelledby="v-pills-t1-tab">
              <form class="admin-form" action="{{route('back.first.banner.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="title1">{{ __('Title') }} *</label>
                  <input type="text" name="title1" class="form-control" id="title1" placeholder="{{ __('Enter Title') }}"  value="{{isset($first_banner['title1']) ? $first_banner['title1'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle1">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle1" class="form-control" id="subtitle1" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($first_banner['subtitle1']) ? $first_banner['subtitle1'] : ''}}" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="title2">{{ __('Title') }} *</label>
                  <input type="text" name="title2" class="form-control" id="title2" placeholder="{{ __('Enter Title') }}"  value="{{isset($first_banner['title2']) ? $first_banner['title2'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle2">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle2" class="form-control" id="subtitle2" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($first_banner['subtitle2']) ? $first_banner['subtitle2'] : ''}}" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title3" class="form-control" id="title3" placeholder="{{ __('Enter Title') }}"  value="{{isset($first_banner['title3']) ? $first_banner['title3'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle3">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle3" class="form-control" id="subtitle3" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($first_banner['subtitle3']) ? $first_banner['subtitle3'] : ''}}" >
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane fade" id="v-pills-t2" role="tabpanel" aria-labelledby="v-pills-t2-tab">
              <form class="admin-form" action="{{route('back.popular.category.update')}}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="popular_title" class="form-control" id="popular_title" placeholder="{{ __('Popular Category') }}" value="{{$popular_category['popular_title']}}" >
                </div>
                <hr>
            ...
            <div class="tab-pane fade" id="v-pills-t5" role="tabpanel" aria-labelledby="v-pills-t5-tab">
              <form class="admin-form" action="{{route('back.secend.banner.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="title1">{{ __('Title') }} *</label>
                  <input type="text" name="title1" class="form-control" id="title1-2" placeholder="{{ __('Enter Title') }}"  value="{{isset($secend_banner['title1']) ? $secend_banner['title1'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle1">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle1" class="form-control" id="subtitle1" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($secend_banner['subtitle1']) ? $secend_banner['subtitle1'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url">{{ __('URL 1') }} *</label>
                  <input type="text" name="url1" class="form-control" id="secondurl1-2" placeholder="{{ __('Enter Banner Url') }}" value="{{$secend_banner['url1']}}" >
                </div>
                <hr>
                <div class="form-group">
                  <label for="name">{{ __('Image 2') }} *</label>
                ...
                <div class="form-group">
                  <label for="title2">{{ __('Title') }} *</label>
                  <input type="text" name="title2" class="form-control" id="title2-2" placeholder="{{ __('Enter Title') }}"  value="{{isset($secend_banner['title2']) ? $secend_banner['title2'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle2">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle2" class="form-control" id="subtitle2" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($secend_banner['subtitle2']) ? $secend_banner['subtitle2'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url">{{ __('URL 2') }} *</label>
                  <input type="text" name="url2" class="form-control" id="secondurl2-2" placeholder="{{ __('Enter Banner Url') }}" value="{{$secend_banner['url2']}}" >
                </div>
                <hr>
                <div class="form-group">
                  <label for="name">{{ __('Image 3') }} *</label>
                ...
                <div class="form-group">
                  <label for="title3">{{ __('Title') }} *</label>
                  <input type="text" name="title3" class="form-control" id="title3-2" placeholder="{{ __('Enter Title') }}"  value="{{isset($secend_banner['title3']) ? $secend_banner['title3'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle3">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle3" class="form-control" id="subtitle3" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($secend_banner['subtitle3']) ? $secend_banner['subtitle3'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url">{{ __('URL 3') }} *</label>
                  <input type="text" name="url3" class="form-control" id="secondurl3-2" placeholder="{{ __('Enter Banner Url') }}" value="{{$secend_banner['url3']}}" >
                </div>
                <div class="form-group">
                  <button type="submit" class="btn btn-secondary ">{{ __('Submit') }}</button>
                </div>
            ...
            <div class="tab-pane fade" id="v-pills-t6" role="tabpanel" aria-labelledby="v-pills-t6-tab">
              <form class="admin-form" action="{{route('back.third.banner.update')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="title1">{{ __('Title') }} *</label>
                  <input type="text" name="title1" class="form-control" id="title1-3" placeholder="{{ __('Enter Title') }}"  value="{{isset($third_banner['title1']) ? $third_banner['title1'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle1">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle1" class="form-control" id="subtitle1" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($third_banner['subtitle1']) ? $third_banner['subtitle1'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url">{{ __('URL 1') }} *</label>
                  <input type="text" name="url1" class="form-control" id="thirdurl1-3" placeholder="{{ __('Enter Banner Url') }}" value="{{$third_banner['url1']}}" >
                </div>
                <hr>
                <div class="form-group">
                  <label for="name">{{ __('Image 2') }} *</label>
                ...
                <div class="form-group">
                  <label for="title2">{{ __('Title') }} *</label>
                  <input type="text" name="title2" class="form-control" id="title2-3" placeholder="{{ __('Enter Title') }}"  value="{{isset($third_banner['title2']) ? $third_banner['title2'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="subtitle2">{{ __('Subtitle') }} *</label>
                  <input type="text" name="subtitle2" class="form-control" id="subtitle2" placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($third_banner['subtitle2']) ? $third_banner['subtitle2'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url">{{ __('URL 2') }} *</label>
                  <input type="text" name="url2" class="form-control" id="thirdurl2-3" placeholder="{{ __('Enter Banner Url') }}" value="{{$third_banner['url2']}}" >
                </div>
                <div class="form-group">
                  <button type="submit" class="btn btn-secondary ">{{ __('Submit') }}</button>
                </div>
            ...
            <div class="tab-pane fade" id="v-pills-t7" role="tabpanel" aria-labelledby="v-pills-t7-tab">
              <form class="admin-form" action="{{route('back.home_page4.banner.update')}}"method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="label1" class="form-control" id="label1" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['label1']) ? $home4_banner['label1'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url1">{{ __('Banner 1 Button Link') }} *</label>
                  <input type="text" name="url1" class="form-control" id="url1" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['url1']) ? $home4_banner['url1']: ''}}" >
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="label2" class="form-control" id="label2" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['label2']) ? $home4_banner['label2'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url2">{{ __('Banner 2 Button Link') }} *</label>
                  <input type="text" name="url2" class="form-control" id="url2" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['url2']) ? $home4_banner['url2'] : ''}}" >
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="label3" class="form-control" id="label3" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['label3']) ? $home4_banner['label3'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url3">{{ __('Banner 3 Button Link') }} *</label>
                  <input type="text" name="url3" class="form-control" id="url3" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['url3']) ? $home4_banner['url3'] : ''}}" >
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="label4" class="form-control" id="label4" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['label4']) ? $home4_banner['label4'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url4">{{ __('Banner 4 Button Link') }} *</label>
                  <input type="text" name="url4" class="form-control" id="url4" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['url4']) ? $home4_banner['url4'] : ''}}" >
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="label5" class="form-control" id="label5" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['label5']) ? $home4_banner['label5'] : ''}}" >
                </div>
                <div class="form-group">
                  <label for="url5">{{ __('Banner 5 Button Link') }} *</label>
                  <input type="text" name="url5" class="form-control" id="url5" placeholder="{{ __('Enter Banner Url') }}"  value="{{isset($home4_banner['url5']) ? $home4_banner['url5'] : ''}}" >
                </div>
                <div class="form-group">
                  <button type="submit" class="btn btn-secondary ">{{ __('Submit') }}</button>
                </div>
...
@endsection
@section('scripts')
<script type="text/javascript" src="{{ asset('assets/back/js/select2.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets/back/js/home-page.js') }}"></script>
<script>
  $('#basic').select2({
    theme: "bootstrap"
  });
