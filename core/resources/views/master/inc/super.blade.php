<ul class="nav">
      ...
      <ul class="nav nav-collapse">
        ...
        <li>
          <a class="sub-link" href="{{ route('back.bulk.product.index') }}">
            <span class="sub-item">{{ __('Importar y Exportar CSV') }}</span>
          </a>
        </li>
        <li>
  ...
  <li class="nav-item">
    <a data-toggle="collapse" href="#locaciones">
      <i class="fas fa-list-alt"></i>
      <p>{{ __('Manage locations') }}</p>
      <span class="caret"></span>
    </a>
    <div class="collapse" id="locaciones">
      <ul class="nav nav-collapse">
        <li>
          <a class="sub-link" href="{{ route('back.distrito.index') }}">
            <span class="sub-item">{{ __('Districts') }}</span>
          </a>
        </li>  
        <li>
          <a class="sub-link" href="{{ route('back.provincia.index') }}">
            <span class="sub-item">{{ __('Provinces') }}</span>
          </a>
        </li>
        <li>
          <a class="sub-link" href="{{ route('back.departamento.index') }}">
            <span class="sub-item">{{ __('Departments') }}</span>
          </a>
        </li>
      </ul>
    </div>
  ...
  <li class="nav-item">
    <a data-toggle="collapse" href="#faqs">
      ...
      <p>{{ __('Administrar Preguntas Frecuentes') }}</p>
      <span class="caret"></span>
    </a>
      ...
      <ul class="nav nav-collapse">
        ...
        <li>
          <a class="sub-link" href="{{ route('back.faq.index') }}">
            <span class="sub-item">{{ __('Preguntas Frecuentes') }}</span>
          </a>
        </li>
      </ul>
    </div>
