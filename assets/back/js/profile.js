$(() => {
  ...
  $(document).on("input keyup keypress", "#adm_renew_password", function(e){
    var valPassFirst = $("#admn_ew_password").val();
    var lengthPassFirst = $("#admn_ew_password").val().length;
    ...
    if(lengthThis == lengthPassFirst || lengthThis > lengthPassFirst){
      if(valThis == valPassFirst){
        ...
        $("#mssg_cConfirmTwoPassAdm").text("Las contraseñas coinciden*");
        $("#mssg_cConfirmTwoPassAdm").removeClass("mssgSpn__error-mssg");
        $("#mssg_cConfirmTwoPassAdm").addClass("mssgSpn__success-mssg");
        setTimeout(() => { $("#mssg_cConfirmTwoPassAdm").text(""); }, 2600); // Desaparecer mensaje...
      }else{
        thisFrmSubmit.addClass("not-process");
        $("#mssg_cConfirmTwoPassAdm").text("Las contraseñas NO coinciden*");
        $("#mssg_cConfirmTwoPassAdm").removeClass("mssgSpn__success-mssg");
        $("#mssg_cConfirmTwoPassAdm").addClass("mssgSpn__error-mssg");
      }
    }else{
      thisFrmSubmit.addClass("not-process");
      $("#mssg_cConfirmTwoPassAdm").text("");
