      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input class="form-control" name="chckpay_ruc" type="text" data-valformat="onlydigits" id="chckpay-ruc" value="" placeholder="RUC" maxlength="11" required>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label for="chckpay-razonsocial">Razón Social</label>
            <input class="form-control" name="chckpay_razonsocial" type="text" id="chckpay-razonsocial" value="" placeholder="Razón Social" required>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label for="chckpay-address">Dirección</label>
            <input class="form-control" name="chckpay_address" type="text" id="chckpay-address" value="" placeholder="Dirección" required>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label for="chckpay-phone">Teléfono</label>
            <input class="form-control" name="chckpay_phone" type="text" data-valformat="withspacesforthreenumbers" id="chckpay-phone" value="" placeholder="Teléfono" maxlength="9" required>
          </div>
        </div>
        <div class="col-12 d-flex align-items-center justify-content-start">
          <div class="form-group">
