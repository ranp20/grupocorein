$(() => {
  ...
  $(document).ready(function (){
    ...
    $(document).on('click', '.list-view', function (){
      ...
      $('#search_form_onsaleproducts #view_check').val(viewCheck);
      $("#search_button_onsaleproducts").click();
    ...
    $(document).on("click", ".brand-select", function (){
      ...
      $("#search_form_onsaleproducts #brand").val(brand);
      removePage();
      $("#search_button_onsaleproducts").click();
    });
    $(document).on("click", "#price_filter", function (){
      ...
      $("#search_form_onsaleproducts #minPrice").val(min_price);
      $("#search_form_onsaleproducts #maxPrice").val(max_price);
      removePage();
      $("#search_button_onsaleproducts").click();
    });
    $(document).on("change", "#sorting", function (){
      let sorting = $(this).val();
      $("#search_form_onsaleproducts #sorting").val(sorting);
      removePage();
      $("#search_button_onsaleproducts").click();
    });
    $(document).on("click", ".widget_price_filter", function (){
      ...
      if(filter_prices){
        ...
        $("#search_form_onsaleproducts #minPrice").val(filter_prices[0]);
        $("#search_form_onsaleproducts #maxPrice").val(filter_prices[1]);
      }else{
        $("#search_form_onsaleproducts #minPrice").val('');
        $("#search_form_onsaleproducts #maxPrice").val('');
      }
      removePage();
      $("#search_button_onsaleproducts").click();
    });
    ...
    $(document).on('click', '#quick_filter li a', function (){
      ...
      $("#search_form_onsaleproducts #quick_filter").val(filter);
      removePage();
      $("#search_button_onsaleproducts").click();
    });
    function removePage(){
      $("#search_form_onsaleproducts #page").val('');
    };
    /*
    ...
    */
    $(document).on('click', '#category_list li a.category_search', function (){
      ...
      removePage();
      $("#search_form_onsaleproducts #childcategory").val('');
      $("#search_form_onsaleproducts #subcategory").val('');
      $("#search_form_onsaleproducts #category").val(category);
      $("#search_button_onsaleproducts").click();
    });
    $(document).on('click', '#subcategory_list li a.subcategory', function (){
      ...
      $("#search_form_onsaleproducts #childcategory").val('');
      $("#search_form_onsaleproducts #subcategory").val(category);
      $("#search_button_onsaleproducts").click();
    });
    $(document).on('click', '#childcategory_list li a.childcategory', function (){
      ...
      removePage();
      $("#search_form_onsaleproducts #childcategory").val(childcategory);
      $("#search_button_onsaleproducts").click();
    });
    $(document).on('click', '#item_pagination .page-item .page-link', function (e){
      ...
      $("#search_form_onsaleproducts #page").val(pagination);
      $("#search_button_onsaleproducts").click();
    });
    $(document).on('click', '.option', function (){
      ...
      removePage();
      $("#search_form_onsaleproducts #option").val(option);
      $("#search_button_onsaleproducts").click();
    });
    $(document).on('submit', '#search_form_onsaleproducts', function (e){
      e.preventDefault();
